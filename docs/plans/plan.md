...
- Drag Actual/Revised within an editable column to reposition it, or between editable columns as move.
...
- Move Actual to Revised and back, then reposition it within Actual.
